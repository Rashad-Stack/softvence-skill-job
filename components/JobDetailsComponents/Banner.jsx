...
export default function Banner({singleJob}) {
    return (
        <section className=" bg-center bg-cover bg-no-repeat w-full" style={{ backgroundImage: `url(${bg.src})` }}>
            <div className='container mx-auto p-2 md:p-2 lg:p-2'>
                <div className='text-white py-32 max-w-[400px] mx-auto md:mx-0 md:max-w-[544px]'>
                    <div>
                        ...
                        <p className='text-lg md:text-[24px] font-semibold leading-normal'>{singleJob.minSalary} - {singleJob.maxSalary}<span className='text-[#C8C8C8] text-[10px] font-medium leading-normal'>BDT/Month</span> </p>
                    </div>
